...
export default function Footer() {
  return (
    <footer className="border-t border-amber-200/70 bg-stone-900 pt-12 pb-8 text-stone-300">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div>
          <h3 className="mb-3 font-serif text-xl font-bold text-amber-400">
            Nallachar
          </h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/our-story" className="transition hover:text-amber-400">
                Our Story
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/cart" className="transition hover:text-amber-400">
                View Cart
              </Link>
            </li>
          </ul>
      ...
      <div className="mt-8 border-t border-stone-800 pt-4 text-center text-xs text-stone-500">
